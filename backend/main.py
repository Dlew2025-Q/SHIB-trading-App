...
# --- CONTRARIAN AI SIGNAL (Reverted to simpler base strategy) ---
...
async def ai_strategy_review(trades: list[dict]):
    ...
    prompt_parts = [
        ...
        "4. **Logic:** The final signal is an INVERSION of the signal generated by the above rules.",
        "\n--- Recent Trade History ---",
        trade_history_str,
        "\n--- Your Analysis Task ---",
        "1. **Identify Patterns:** Analyze the losing trades. Is there a common reason for failure? (e.g., stop-loss too tight, inverting a good signal, etc.).",
        "2. **Propose Adjustments:** Based on the patterns, suggest specific, numerical adjustments to the strategy rules. Do not be vague.",
        "   - **Good Suggestion:** 'The contrarian logic is failing. The base momentum signals are often correct. Recommend removing the inversion and trading the original signal directly.'",
