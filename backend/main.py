...
async def ai_strategy_review(trades: list[dict]):
    ...
    for trade in trades:
        formatted_trades.append(
            ...
            f"Type: {trade.get('signal_type', trade.get('signalType'))}, Status: {trade['status']}, "
            f"Reasoning: '{trade.get('ai_reasoning', trade.get('aiReasoning'))}'"
        )
